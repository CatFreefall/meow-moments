...
const postLikedByUser = "SELECT * FROM post_likes WHERE post_id = $1 AND user_id = $2";
...
export { postContent, addTag, addPostHashtags, getTag, getPostsByRecent, postLikedByUser, deletePostLike, addPostLike, getPostLikes };